...
export function RawTelemetry({ packet }: Props) {
  if (!packet) {
    return <div className="p-4 text-app-text-dim">Waiting for telemetry data...</div>;
  }
  ...
  return (
    <div className="p-4 overflow-auto h-full">
      <div className="text-xs text-app-text-muted uppercase tracking-wider mb-3">All Telemetry Values ({entries.length} fields)</div>
